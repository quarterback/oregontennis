            ...
            <table style="margin-bottom: 2rem;">
                ...
                <tbody>
                    <tr class="tier-red">
                        ...
                        <td>4A</td>
                        <td>1,120 mi</td>
                        <td>R1: @Phoenix (316mi) → QF: @Sweet Home (236mi) → SF: @Astoria (283mi)</td>
                    </tr>
                    <tr class="tier-red">
                        ...
                        <td>3A</td>
                        <td>1,103 mi</td>
                        <td>R1: @Lakeview (200mi) → QF: @Glide (297mi) → SF: @Blanchet (292mi)</td>
                    </tr>
                    <tr class="tier-red">
                        <td><strong>Union / Cove</strong></td>
                        <td>2014</td>
                        <td>Softball</td>
                        <td>2A/1A</td>
                        <td>1,102 mi</td>
                        <td>R1: @Regis (242mi) → QF: @Butte Falls (298mi) → SF: @N. Douglas (289mi)</td>
                    </tr>
                    <tr class="tier-red">
                        <td><strong>McLoughlin</strong></td>
                        <td>2016</td>
                        <td>Softball</td>
                        <td>4A</td>
                        <td>1,096 mi</td>
                        <td>R1: @Hidden Valley (346mi) → QF: @Douglas (315mi) → SF: @Gladstone (206mi)</td>
                    </tr>
                    <tr class="tier-red">
                        ...
                        <td>4A</td>
                        <td>1,015 mi</td>
                        <td>R1: @Seaside (286mi) → QF: @Philomath (183mi) → SF: @Astoria (297mi)</td>
                    </tr>
                </tbody>
            </table>

            <h3 style="margin: 1.5rem 0 1rem 0; color: #1a365d;">🗺️ Eastern Oregon Travel Burden (2014-2025)</h3>
            <table style="margin-bottom: 2rem;">
                <thead>
                    <tr>
                        <th>Team</th>
                        <th>Long-Haul Games</th>
                        <th>Avg Away Miles</th>
                        <th>Burden Level</th>
                    </tr>
                </thead>
                <tbody>
                    <tr class="tier-red"><td>Nyssa</td><td>6</td><td>311 mi</td><td>🔴 Extreme</td></tr>
                    <tr class="tier-red"><td>Joseph</td><td>9</td><td>308 mi</td><td>🔴 Extreme</td></tr>
                    <tr class="tier-yellow"><td>Enterprise</td><td>11</td><td>291 mi</td><td>🟡 High</td></tr>
                    <tr class="tier-yellow"><td>Vale</td><td>22</td><td>291 mi</td><td>🟡 High</td></tr>
                    <tr class="tier-yellow"><td>Ontario</td><td>9</td><td>280 mi</td><td>🟡 High</td></tr>
                    <tr class="tier-yellow"><td>Union</td><td>22</td><td>277 mi</td><td>🟡 High</td></tr>
                    <tr class="tier-yellow"><td>Weston-McEwen</td><td>20</td><td>260 mi</td><td>🟡 High</td></tr>
                    <tr class="tier-yellow"><td>McLoughlin</td><td>19</td><td>253 mi</td><td>🟡 High</td></tr>
                    <tr class="tier-yellow"><td>Baker</td><td>11</td><td>251 mi</td><td>🟡 High</td></tr>
                    <tr class="tier-green"><td>La Grande</td><td>33</td><td>246 mi</td><td>🟢 Moderate</td></tr>
                </tbody>
            </table>
